<template>
         ...
         <section id="products" class="mt-4">
                <div class="container">
                    <div class="row">
                        <div class="col text-center text-uppercase">
                            <h1 class="menu-title" id="hamburguers">Carta Hamburguesas</h1>
                        </div>
                    </div>
                    <!-- Products here -->
                    <!-- hamburgers -->
                    <div class="row" v-if="hb.length">
                        <div class="col-md-6 col-lg-3 mt-3 mb-4" v-for="(item) in hb" :key="item.id">
                            <div class="card" >
                    ...
                    <div class="row">
                        <div class="col text-center text-uppercase">
                            <h1 class="menu-title" id="hotdogs">Carta Perros Calientes</h1>
                        </div>
                    </div>

                    <!-- hotdogs here -->
                    <div class="row" v-if="hd.length">
                        <div class="col-md-6 col-lg-3 mt-3 mb-4" v-for="(item) in hd" :key="item.id">
                            <div class="card" >
                                <img :src="item.img" class="card-img-top" alt="hd1" data-bs-toggle="modal" :data-bs-target="item.idModal">
                                <div class="card-body">
                                    <h5 class="card-title" v-text="item.name"></h5>
                            ...
                            <!-- modals hotdogs -->
                            <div id="modals">
                                <div class="modal fade" :id="item.idUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" v-for="(item) in hd" :key="item.idm">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center" id="exampleModalLabel" v-text="item.name"></h5>
                                            ...
                                            <div class="modal-footer">
                                                <button @click="addToCart(item)" type="button" class="agregarc"><strong>AGREGAR</strong></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <hr>
                    <div class="row">
                        <div class="col text-center text-uppercase">
                            <h1 class="menu-title" id="hotdogs">Otros</h1>
                        </div>
                    </div>

                    <!-- Other here -->
                    <div class="row" v-if="other.length">
                        <div class="col-md-6 col-lg-3 mt-3 mb-4" v-for="(item) in other" :key="item.id">
                            <div class="card" >
                                <img :src="item.img" class="card-img-top" alt="other" data-bs-toggle="modal" :data-bs-target="item.idModal">
                                <div class="card-body">
                                    <h5 class="card-title" v-text="item.name"></h5>
                                    <!-- <p class="card-text"><strong  v-text="item.desc"></strong></p> -->
                                    <h4 class="text-center mb-3"><strong>$ </strong> <span><strong v-text="item.price"></strong></span></h4>
                            ...
                            <!-- modals Other -->
                            <div id="modals">
                                <div class="modal fade" :id="item.idUser" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" v-for="(item) in other" :key="item.idm">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title text-center" id="exampleModalLabel" v-text="item.name"></h5>
                                            ...
                                            <div class="modal-body">
                                                <img :src="item.img" class="card-img-top" alt="other">
                                                <h4>Descripción:</h4>
                                                <p v-text="item.description"></p>
                                                <div class="input-group mb-3">
                                                    <span class="input-group-text bg-dark"><button @click="minusbtn(item)" type="button" class="btn btn-dark"><i class="fas fa-minus"></i></button></span>
...
const {hb, hd, other } = storeToRefs(ProductsStore)
